...
with st.sidebar:
    ...
    if st.button(f"{'Light Mode' if is_dark else 'Dark Mode'}", key="theme_toggle", use_container_width=True, help=f"Click to {theme_label.lower()}"):
...
if page == "Dashboard":
    ...
    <div class="promo-card hero-card">
        ...
        <div>
            <a href="?page=Main+Owner+Guide" class="card-cta">Start Onboarding</a>
        </div>
    </div>
    """, unsafe_allow_html=True)
